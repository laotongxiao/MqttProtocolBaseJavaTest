...
public class TestSubscribeProtocol{
    ...
    */
    public class SubscribeContent{
        ...
        public int getTopicQosLevelLEN() {
            return topicQosLevelLEN;
        }

        public int getTopicQosLevel() {
            return topicQosLevel;
        }

        public void setTopicQosLevel(int topicQosLevel) {
            this.topicQosLevel = topicQosLevel;
        }
    ...
    public byte[] genContentData() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            byte topicQosLevel= (byte)(list.get(i).getTopicQosLevel() & 0xFF);
    ...
    public void parseContentData(byte[] data) {
        ...
        do{
            ...
            pos += topicNameSize;
            //服务质量
            int topicQosLevel = data[pos] & 0x3;
            subscribeContent.setTopicQosLevel(topicQosLevel);
            pos += 1;
            //把数据加入list中
